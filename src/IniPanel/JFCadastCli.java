...
import IniPanel.FrameIni.*;
/**
 *
 * @author Haunter
 */
public class JFCadastCli extends javax.swing.JFrame {
...
ResultSet rs = null;
 ...
 private void PesquisarCliente(){
           String sql ="Select * from nome where nome like ?";
           try {
 ...
 private void PesquisarNavi(){
           String sql ="Select * from navio where nome like ?";
           try {
               pst=conexao.prepareStatement(sql);
 ...
 private void PesquisarUsin(){
           String sql ="Select * from usina where nome like ?";
           try {
               pst=conexao.prepareStatement(sql);
 ...
 private void PesquisarDes(){
           String sql ="Select * from pdesembaque where nome like ?";
           try {
               pst=conexao.prepareStatement(sql);
 ...
 private void PesquisarEmb(){
           String sql ="Select * from pembarque where nome like ?";
           try {
               pst=conexao.prepareStatement(sql);
    ...
    private void adicionar(){
     String sql ="insert into service(serviço, Cliente, Navio, Usina, Embarque, Desembarque, Data, Quantidade) values(?, ?, ?, ?, ?, ?, ?, ?)";
...
PesquisarNavi();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCadastCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
